	 ...
	 m_bWorkDirChanged(false)
{
	...
	BoxSizer4->Add(BoxSizer2, 0, wxTOP|wxLEFT|wxRIGHT|wxEXPAND, 5);
	...
	BoxSizer8->Add(m_TreeMenu, 1, wxTOP|wxBOTTOM|wxLEFT|wxEXPAND, 5);
	...
	BoxSizer5->Add(m_btnUp, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5);
	...
	BoxSizer5->Add(m_btnDown, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5);
	...
	BoxSizer5->Add(m_btnNewDir, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5);
	...
	BoxSizer5->Add(m_btnNewItem, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5);
	BoxSizer5->Add(20,23,1, wxLEFT|wxRIGHT|wxEXPAND, 5);
	...
	m_btnDel->SetDefault();
	BoxSizer5->Add(m_btnDel, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5);
	BoxSizer8->Add(BoxSizer5, 0, wxTOP|wxBOTTOM|wxEXPAND, 5);
	BoxSizer4->Add(BoxSizer8, 1, wxTOP|wxBOTTOM|wxLEFT|wxEXPAND, 5);
	BoxSizer3->Add(BoxSizer4, 0, wxTOP|wxBOTTOM|wxLEFT|wxEXPAND, 5);
	...
	BoxSizer7->Add(BoxSizer9, 0, wxALL|wxEXPAND, 5);
	...
	BoxSizer11->Add(BoxSizer10, 0, wxEXPAND, 5);
	...
	BoxSizer11->Add(BoxSizer17, 1, wxALIGN_CENTER_HORIZONTAL, 5);
	BoxSizer7->Add(BoxSizer11, 0, wxALL|wxEXPAND, 5);
	...
	BoxSizer13->Add(BoxSizer12, 0, wxEXPAND, 5);
	...
	BoxSizer13->Add(BoxSizer18, 1, wxEXPAND, 5);
	BoxSizer7->Add(BoxSizer13, 0, wxALL|wxEXPAND, 5);
	...
	BoxSizer15->Add(BoxSizer14, 0, wxEXPAND, 5);
	...
	BoxSizer7->Add(BoxSizer16, 0, wxALL|wxEXPAND, 5);
	...
	BoxSizer7->Add(BoxSizer6, 0, wxALIGN_RIGHT, 5);
	BoxSizer3->Add(BoxSizer7, 1, wxTOP|wxBOTTOM|wxRIGHT|wxEXPAND, 5);
	BoxSizer1->Add(BoxSizer3, 1, wxALIGN_CENTER_HORIZONTAL, 5);
	SetSizer(BoxSizer1);
